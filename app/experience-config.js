(() => {
  ...
  const THEME_KEY='haki_app_theme_v1';
  ...
  const themeIcon=theme=>theme==='claro'
    ? '<svg class="theme-icon-moon" viewBox="0 0 24 24" aria-hidden="true"><path d="M20.2 15.2A8.5 8.5 0 0 1 8.8 3.8 8.5 8.5 0 1 0 20.2 15.2Z"/></svg>'
  ...
  function setupCatalogMenus(){
    ...
    if(backHome){
      ...
      backHome.setAttribute('aria-label','Volver a las prendas');
      backHome.innerHTML='<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M19 12H5m7-7-7 7 7 7"/></svg>';
    }
    ...
    if(!document.getElementById('haki-catalog-menu-style')){
      ...
      style.textContent=`
        ...
        .haki-chevron-back::before{content:none!important;display:none!important}
